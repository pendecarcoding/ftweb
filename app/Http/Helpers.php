...
function getuseraccount($id){
    try {
        return GsystemAccount::where('id',$id)->first();
    } catch (\Throwable $th) {
        //throw $th;
    }
}
function car_typebyCarId($id){
    try {
        $data = DB::table('cars')->join('type_cars','type_cars.id','cars.type')->where('cars.id',$id)->first();
        return $data;
    } catch (\Throwable $th) {
        //throw $th;
    }
}
function type_car($id){
    try {
        $data = DB::table('type_cars')->where('id',$id)->first();
        return $data;
    } catch (\Throwable $th) {
        //throw $th;
    }
}
function make_car($id){
    try {
...
function getinfoaccount(){
    $data = GsystemAccount::where('id',Session::get('id_account'))->first();
    return $data;
}
