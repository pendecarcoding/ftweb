...
Route::controller(LeadershipController::class)->group(function () {
    Route::get('/leadership/create', 'create')->name('leadership.create');
    Route::get('/leadership/edit/{id}', 'edit')->name('leadership.edit');
    Route::get('/leadership/destroy/{id}', 'destroy')->name('leadership.destroy');
});
//Permission
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    //Type Cars
    Route::resource('typecars', TypeCarsController::class);
    Route::controller(TypeCarsController::class)->group(function () {
        Route::get('/typecars/edit/{id}', 'edit')->name('typecars.edit');
        Route::get('/typecars/destroy/{id}', 'destroy')->name('typecars.destroy');
    });
    ...
    Route::controller(CarsController::class)->group(function () {
        ...
        Route::get('/cars/destroy/{id}', 'destroy')->name('cars.destroy');
    });
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/getcarfrombrandId', 'getcarfrombrandId')->name('getcarfrombrandId');
    ...
    Route::resource('seatprice', SeatpriceController::class);
