	...
	var dzTheme = function(){
		...
		if(screenWidth < 991)
		{
			if ($('.mo-left .header-nav').children('div').length == 0) {
                var mainUrl = 'https://feytech.com.my';
                var logoData = jQuery('<div>').append($('.mo-left .logo-header').clone()).html();

                // Set the logo image source using the main URL
                jQuery('.mo-left .header-nav .logo-header > a > img').attr('src', mainUrl + '/images/logo.png');
                jQuery('.mo-left .header-nav').prepend(logoData);

                // Set the logo image source for white logo
                jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src', mainUrl + '/images/logo-white.png');
            }
		}else{
