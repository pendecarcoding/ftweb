...
! function () {
    ...
    window.MaterialMenu = d, d.prototype.Constant_ = {
        ...
        if (this.element_ && this.container_ && this.outline_) {
            ...
            this.container_.style.width = s + "px", this.container_.style.height = t + "px", this.outline_.style.width = s + "px", this.outline_.style.height = t + "px", this.container_.style.top = "60px";
