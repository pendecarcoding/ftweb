    ...
    <main id="my-pdf">
        ...
        onload="disableContextMenu();" onMyLoad="disableContextMenu();"> </iframe> -->
                            ...
                            <input value="1" type="checkbox" name="allow_handbook" onclick="disableCheckbox(this)"
                                id="myCheckbox" {{ checkagree('ethic') }}> &nbsp;By clicking here, I state that I have read
                            and understood the Ethics and Compliance Whistleblowing Policy and Procedures
                            ...
                            <script type="text/javascript">
                                document.addEventListener("adobe_dc_view_sdk.ready", function() {
                                    ...
                                    adobeDCView.previewFile({
                                        content: {
                                            location: {
                                                url: "/public/aceweb/pdf/ethic.pdf"
                                            }
                                        },
                                        metaData: {
                                            fileName: "."
