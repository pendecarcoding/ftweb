            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-9" style="padding: 36px;">
                        <div style="display: flex;"><input style="width:100%" type="text" class="form-control"
                                placeholder="Announcement"><span><button class="btn btn-primary">SEARCH</button></span>
                        </div>
                            ...
                            @foreach ($announce as $i => $v)
                                <div class="list-content">
                                    <a style="text-decoration: none;"
                                        href="{{ route('staff.detailannouncements', base64_encode($v->id)) }}">
