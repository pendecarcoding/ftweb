            ...
            <form class="pad-hor" method="POST" role="form" action="{{ route('staff.login') }}">
                ...
                <div>
                    <div class="input-group mb-3">
                        ...
                        <input required name="username" type="text" class="form-control" placeholder="Staff ID"
                ...
                <div class="form-group">
                    ...
                    <center>
                        <p style="margin-top: 5px;color:#959595">Don't have an account? <span><a
                                    style="color:#959595;text-decoration: none;" href="{{ url('registerstaff') }}">Create
                                    account</a></span></p>

                        <p><span><a style="color:#959595;text-decoration: none;" href="{{ url('forgotpass') }}">Forgot
                                    Password</a></span></p>
                    </center>
