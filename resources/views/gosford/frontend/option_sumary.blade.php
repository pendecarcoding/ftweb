                                        ...
                                        <div class="card">
                                            <div class="slider-product">
                                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                                    ...
                                                    <a class="carousel-control-prev icon-arrow" href="#carouselExampleIndicators" role="button" data-slide="prev">
                                                        <i class="fa fa-chevron-left"></i>
                                                    </a>
                                                    <a class="carousel-control-next icon-arrow" href="#carouselExampleIndicators" role="button" data-slide="next">
                                        ...
                                        <div class="card go-right-order" style="height: 409px;">
                                         <div style="padding: 27px;">
                                            ...
                                            <div style="display: flex;flex-direction: column;">
                                                ...
                                                <select onchange="getValueMaterial()" style="font-weight: bold;color: #dc3545;" class="select-order mdl-textfield__input" type="text" name="material" id="material" required>
                                            ...
                                            <div style="display: flex;flex-direction: column;">
                                                ...
                                                <div style="display: flex;justify-content: space-between;">
                                                    <a href="{{url('product_project')}}" style="padding: 0px 30px;" type="submit" class="mdl-button mdl-js-button mdl-button--raised btn-back" data-upgraded=",MaterialButton">
                                                        Back
                                                    </a>
