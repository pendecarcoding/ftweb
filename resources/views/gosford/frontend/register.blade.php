            ...
            <div class="content-ace">
                <div class="wrap-content">
                    ...
                    <div style="padding-top: 0px" class="ace-isi about">
                        ...
                        <div class="container" id="register-user">
                            <div class="mdl-card
                            mdl-card__login mdl-shadow--2dp">
                                    ...
                                    <div class="mdl-grid">
                                        ...
                                        <form action="{{ route('gosford.addacount.front') }}" method="post">@csrf
                                            <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone">
                                                ...
                                                <div
                                                    class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                                    <input
                                                        placeholder="Contact Number  (Please enter a valid contact number)"
                                                        name="contact_number" class="mdl-textfield__input" type="text"
                                                        required>

                                                </div>
                                                <div
                                                    class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                                    <input placeholder="Email Address (Please enter a valid email address)"
                                                        name="email" class="mdl-textfield__input" type="text" required>
                                                ...
                                                <div style="text-align: center;color:#747474 ;"
                                                    class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label full-size">
                                                    <span><input type="checkbox" class="btn-check" id="btn-check-outlined"
                                                            autocomplete="off">
                                                        <label class="btn btn-outline-primary" for="btn-check-outlined"><img
                                                                src="/public/aceweb/assets/img/check-circle.png"
                                                                alt=""></label></span><span> &nbsp; I’ve read and
                                                        agree
                                                        to</span> <span><a class="login-link" href="#">Terms &
                                                            Conditions</a></span>
                                                </div>
                                                <br>
                                                <center>
                                        ...
                                        <center>
                                            <div style="justify-content: center;"
                                                ...
                                                <a style="color: #00bcd4;" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal" class="login-link">Login here</a>
