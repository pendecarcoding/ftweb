...
@section('content')
    <main>
        ...
        position: absolute;
        width: 100%;">
            <div class="banner-video-div" style="width:100%;position: relative;overflow: hidden;display: flex;
            ...
            <div style="display: flex;flex-direction: column;">
                <div style="position: relative;">
                    <div class="row" style="padding-left: 0px;padding-right: 0px;--bs-gutter-x: 0;">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12" style="position: relative;overflow: hidden;">
                            <img class="img-research" style="width: 100%;" src="/public/go_system/images/research/cut_img.svg" alt="">
                        </div>
                    </div>
                </div>
                <div style="position: relative;">
                    <div class="row" style="padding-left: 0px;padding-right: 0px;--bs-gutter-x: 0;">
                        <div class="col-md-6 col-lg-6 col-sm-12" style="position: relative;overflow: hidden;">
                            <img class="img-research" style="width: 100%;" src="/public/go_system/images/research/cut_img_2.svg" alt="">
                        </div>
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <div class="padding-research">
                            <h5 style="color: #E20000;">CUT DESIGN | MANUFACTURING.</h5>
                ...
                <div style="position: relative;">
                    <div class="row" style="padding-left: 0px;padding-right: 0px;--bs-gutter-x: 0;">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12" style="position: relative;overflow: hidden;">
                            <img class="img-research" style="width: 100%;" src="/public/go_system/images/research/cut_img_3.svg" alt="">
                        </div>
