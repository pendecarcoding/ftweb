            ...
            <div class="wrap-content">
                <div style="padding-top: 0px" class="ace-isi">
                    ...
                    <div class="title-order">
                        <h3>Vehicles: {{ $year }} {{ make_car($carmake)->name }} {{ car_typebyCarId($model)->name }} <span><a
                                    href="{{ url('product_project') }}" class="btn"
                                    style="background-color: #474747;color:white;border-radius: 20px;">
