                    ...
                    <div style="padding-top: 0px" class="ace-isi">
                        <div class="step-order">
                            ...
                            <div class="title-step-order">
                                <button
                                    class="btn-step mdl-button mdl-js-button mdl-button--raised button--colored-light-blue"
                                    disabled="" data-upgraded=",MaterialButton"></button>
                                <p>Options Summary</p>
                            </div>
                        </div>
                        <div class="title-order">
                            <h3>Vehicles: {{ $year }} {{ make_car($carmake)->name }}
                                {{ car_typebyCarId($model->id)->name }} <span><a href="{{ url('product_project') }}"
                                        class="btn" style="background-color: #474747;color:white;border-radius: 20px;">
                                        <div style="display: flex;"><i class="material-icons">cached</i>&nbsp; Change</div>
                                    </a></span></h3>
                                ...
                                @foreach ($car as $i => $vcar)
                                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                                        <div class="card w-100 my-2 shadow-2-strong">
                                            ...
                                            <a href="{{ route('gosford.front.optionsummary', $vcar->slug) }}">
