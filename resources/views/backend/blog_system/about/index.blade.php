    ...
    <div class="card">
        ...
        <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
                <h5 class="mb-md-0 h6">{{ translate('About Us ') }}</h5>
            </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>PDI PROJECT</label>
                    <input type="hidden" name="types[]" value="ABOUT_COUNT_PDI_PROJECT">
                    <input name="ABOUT_COUNT_PDI_PROJECT"  value="{{ env('ABOUT_COUNT_PDI_PROJECT') }}" type="text" class="form-control">
                </div>
                <div class="col-md-3">
                    <label>OEM PROJECTS</label>
                    <input type="hidden" name="types[]" value="ABOUT_COUNT_OEM_PROJECT">
                    <input name="ABOUT_COUNT_OEM_PROJECT" value="{{ env('ABOUT_COUNT_OEM_PROJECT') }}" type="text" class="form-control">
                </div>
            </div>
