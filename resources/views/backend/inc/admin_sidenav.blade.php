<div class="aiz-sidebar-wrap">
    ...
    color: #5c7a9f;" href="{{ route('admin.dashboard') }}"
                ...
                @if (get_setting('system_logo_white') != null)
                    <img style="    background-color: white;" class="mw-100"
                        src="{{ uploaded_asset(get_setting('system_logo_white')) }}" class="brand-icon"
                        alt="{{ get_setting('site_name') }}">
                @else
                    <img style="    background-color: white;" class="mw-100"
                        src="{{ uploaded_asset(get_setting('site_icon')) }}" class="brand-icon"
                        alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
                            ...
                            @can('view_all_brands')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('brands.index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Car Make') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_all_brands')
                            ...
                            @can('view_company')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('company.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['company.create', 'company.edit']) }}">
                            ...
                            @can('view_leadership')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('leadership.index') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['leadership.create', 'leadership.edit']) }}">
                                        <span class="aiz-side-nav-text">{{ translate('Leadership') }}</span>
                                    </a>
                                </li>
                            @endcan
