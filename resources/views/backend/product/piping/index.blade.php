        ...
        <div class="card">
            <div class="card-header row gutters-5">
                <div class="col text-center text-md-left">
                    <h5 class="mb-md-0 h6">{{ translate('Piping') }}</h5>
                </div>
                <div class="col text-center text-md-right">
                    <a href="{{ route('pipingsys.create') }}" class="btn btn-primary btn-sm" style="color:white">Add
                        Item</a>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <td>
                                        @can('edit_twotowncolor')
                                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                                href="{{ route('pipingsys.edit', base64_encode($v->id)) }}"
                                        ...
                                        @can('delete_twotowncolor')
                                            <a href="#"
                                                ...
                                                data-href="{{ route('pipingsys.destroy', base64_encode($v->id)) }}"
...
@section('script')
    <script type="text/javascript">
        ...
        function update_published(el) {
            ...
            $.post('{{ route('pipingsys.published') }}', {
                _token: '{{ csrf_token() }}',
                id: el.value,
                status: status
            }, function(data) {
