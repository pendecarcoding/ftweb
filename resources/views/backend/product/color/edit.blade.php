                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Name') }}" id="name" name="name"
                                class="form-control" required value="{{ $color->name }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Color Code') }}" id="code" name="code"
                                class="form-control" required value="{{ $color->code }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input style="width:100px;height:100px" type="color"
                                placeholder="{{ translate('Hex Color') }}" id="code" name="hex_color"
                                class="form-control" required value="{{ $color->hex_color }}">
                        </div>
                    </div>

                    <div class="form-group mb-3">
                        <label for="name">{{ translate('Extra Price') }}</label>
                        <input type="number" value="{{ $color->extraprice }}"
                            placeholder="{{ translate('Extra Price') }}" id="extraprice" name="extraprice"
