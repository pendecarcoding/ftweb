        ...
        @can('add_brand')
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('leathergeneric.update',$edit->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="type" id="">
                                    ...
                                    @foreach ($type as $i => $v)
                                        <option value="{{ $v->leather }}" @if($v->leather==$edit->type) selected @endif>{{ $v->leather }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="{{ translate('Short By') }}" name="shortby" value="{{$edit->shortby}}" class="form-control"
                                    required>
                            </div>
                            <div class="form-group mb-3">
