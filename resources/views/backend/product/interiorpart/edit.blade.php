                        ...
                        <form action="{{ route('interiorpart.update',$edit->id_interior) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input value="{{$edit->img}}" type="hidden" name="image" class="selected-files">
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" value="{{$edit->name_interior}}" placeholder="{{ translate('Name') }}" name="name" class="form-control"
                                    required>
                            </div>

                            <div class="form-group mb-3">
                                <label for="name">{{ translate('Price') }}</label>
                                <input type="number" value="{{$edit->price}}" placeholder="{{ translate('Price') }}" name="price" class="form-control"
                                    required>
                            </div>
                            <!-- <div class="form-group mb-3">
