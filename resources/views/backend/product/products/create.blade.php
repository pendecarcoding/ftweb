                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="car">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="car_id" id="car_id" data-live-search="true">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" x-data="handler()">
                            ...
                            <table class="table table-bordered align-items-center table-sm">
                              ...
                              <tbody>
                                <template x-for="(field, index) in fields" :key="index">
                                 <tr>
                                  ...
                                  <td><input x-model="field.txt1" type="text" name="materialName[]" class="form-control" required></td>
                                  <td><input x-model="field.txt2" type="text" name="materialPrice[]" class="form-control" required></td>
                              ...
                              <tfoot>
                                 <tr>
                                   <td colspan="4" class="text-right"><button type="button" class="btn btn-info" @click="addNewField()">+ Add Material</button></td>
                                </tr>
                              </tfoot>
                            </table>
                            </div>
