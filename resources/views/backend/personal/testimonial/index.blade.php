...
@section('content')
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            ...
            @can('add_personaltestimonial')
                <div class="col text-right">
                    <a href="{{ route('personaltestimonial.create') }}" class="btn btn-circle btn-info">
                            ...
                            <td>
                                @can('edit_personaltestimonial')
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                        href="{{ route('personaltestimonial.edit', base64_encode($v->id)) }}"
                                        title="{{ translate('Edit') }}">
                                        <i class="las la-pen"></i>
                                    </a>
                                @endcan
                                @can('delete_personaltestimonial')
                                    <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                        data-href="{{ route('testimonial.destroy', $v->id) }}"
