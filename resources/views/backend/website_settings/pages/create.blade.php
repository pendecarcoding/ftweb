...
<div class="row">
    <div class="col-md-8">
        <div class="form-group row">
            <div class="col-sm-12">
                <input type="text" class="form-control" placeholder="{{translate('Add Title')}}" name="title" required>
            </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-12">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div style="display: flex;">
                <button type="submit" name="publish" value="Y" class="btn btn-primary btn-sm">Save And Publish</button>
                <button type="submit" name="publish" value="N" class="btn btn-primary btn-sm">Save Draft</button>
            </div>
            </div>
        </div>
        <div class="card">
            <div class="card-header"><h6>Page Atributes</h6></div>
            <div class="card-body">
                <div class="form-group row">
                    <label for="name">{{translate('Template')}} <span class="text-danger">*</span></label>
                    <div class="col-sm-12">
                        <select name="template" id="" class="form-control" required>
                            <option value="single_sidebar">Single Sidebar</option>
