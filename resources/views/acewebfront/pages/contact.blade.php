...
@section('meta')
    <meta property="og:image" content="{{ uploaded_asset(get_setting('site_logo')) }}" />
@endsection
@section('content')
    <main>
                                     ...
                                     <div class="contact-form">
                                         ...
                                         <form id="contact-form" method="post">
                                             ...
                                             <div class="form-group">
                                                 <label class="control-label col-sm-12" for="fname">Select an
                                                     Option:</label>
                                                 <div class="col-sm-10">
                                             ...
                                             <div class="form-group">
                                                 <p>Thank you. How would you like us to get in touch <br>with you ?</p>
                                             </div>
                                             <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                 <div class="g-recaptcha"
                                                     data-sitekey="6LdcFusnAAAAAO345wsQQNNeO7NTP8-dITus2JwJ"></div>
                                             </div>
                                             <div class="form-group">
                                                 <div id="alertpatner"
                                                 ...
                                                 <div class="col-sm-offset-2 col-sm-10">
                                                     <button type="submit" class="ace-button-black"
