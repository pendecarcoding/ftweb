                ...
                <div class="text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            ...
                            height="50">
                            <h1 class="h3 mb-0" style="color:#dc3545;font-weight: bold;">Create an account</h1>
                        ...
                        <form class="pad-hor" method="POST" role="form" action="{{route('stuff.register')}}">
                            ...
                            border: #dc3545;" type="submit" class="btn btn-primary btn-lg btn-block">
                                SIGN UP
                            </button>
                            <a href="{{url('investor_relations')}}" style="background-color:#5c5b5c;border-color: #5c5b5c;" type="submit" class="btn btn-primary btn-lg btn-block">
                                SIGN IN
                            </a>
                        </form>
