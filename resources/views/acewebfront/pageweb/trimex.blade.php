    ...
    <div class="page-content bg-white">
                        ...
                        <div class="item" style="padding: 20px;">
                            <div class="dlab-box">
                                <div class="dlab-media" style="border-radius: 5px;"> <a href="#"><img
                                            class="img-what-we-do" src="{{ getimage($vg->img) }}" alt=""></a>
                                </div>
                                <div class="dlab-info p-a20 text-center bg-gray">

                                    <p style="text-transform: capitalize;" class="m-b0" class="wwd-text text-capitalize">
                                        {{ $vg->title }}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="section-full bg-white content-inner">
            <div class="wrap-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="description-service" style="color:#999999;text-align: center;">Car seats are a crucial
                            element in modern automobiles for
