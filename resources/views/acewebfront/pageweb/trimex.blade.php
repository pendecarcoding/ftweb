        ...
        <!-- <div class="section-full bg-img-fix content-inner-1"
            ...
            <div class="wrap-content">
                <div class="section-head text-center text-white">
                    <h2 class="text-capitalize" style="color: #343F52;font-family: 'Space Grotesk';font-weight: bold;">Our Products </h2>
                        ...
                        <div data-aos="zoom-in" data-aos-delay="{{$i+4}}00" class="col-lg-4 col-sm-6 m-b30">
                            <div class="dlab-box">
                                ...
                                <div class="dlab-info p-a30 bg-white">
                                    <h4 class="dlab-title m-t0"><a href="#" style="color: #343F52;font-family: 'Space Grotesk';font-weight: bold;"><center>{{$product[$i]}}</center></a></h4>
